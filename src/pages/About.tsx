  ...
  const faqItems = [
    {
      ...
      a: "아닙니다. 본 사이트는 공영홈쇼핑(한국공영홈쇼핑 주식회사)과 공식적인 관계가 없는 독립 정보 안내 사이트입니다. 입점 신청, 공식 문의는 반드시 공영홈쇼핑 공식 홈페이지를 이용해 주세요.",
    },
    {
      q: "여기 나온 정보를 그대로 따라도 괜찮나요?",
      a: "본 사이트의 정보는 참고 목적으로만 제공됩니다. 입점 조건, 서류 요건, 심사 기준 등은 공영홈쇼핑의 정책 변경에 따라 달라질 수 있으므로, 중요한 결정 전에는 반드시 공영홈쇼핑 공식 채널에서 최신 정보를 직접 확인하시기 바랍니다.",
    },
    {
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-10">
          ...
          <div className="bg-card border border-card-border rounded-xl p-6 space-y-3 text-sm text-muted-foreground leading-relaxed">
            ...
            <p>
              모든 정보는 참고 목적이며, 공영홈쇼핑의 실제 정책 및 절차는 반드시 공식 채널에서 직접 확인하세요.
              이 사이트는 공영홈쇼핑의 공식 채널이 아닙니다.
            </p>
          </div>
        </section>
